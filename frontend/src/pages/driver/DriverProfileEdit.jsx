...
export const DriverProfileEdit = () => {
  ...
  if (loading)
    return <div className="container-fluid px-4">Loading...</div>;
        ...
        <div className="container-fluid px-4" style={{ paddingTop: '50px' }}>
          ...
          <div className="card mb-4">
            ...
            <div className="container mt-4">
              ...
              <div className="card">
                <div className="card-body">
                  <form id="edit_form"onSubmit={handlePasswordUpdate}>
