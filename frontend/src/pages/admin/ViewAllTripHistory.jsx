...
export const ViewAllTripHistory = () => {
  ...
  return (
    <div className="container-fluid px-4" style={{ paddingTop: "50px" }}>
      <h1 className="mt-4">View Trip History</h1>
      <ol className="breadcrumb mb-4">
        <li className="breadcrumb-item">
          <a href="/dashboard">Dashboard</a>
        </li>
        <li className="breadcrumb-item active">View All Trip History</li>
      </ol>
          ...
          <div className="row mb-3">
            <div className="col-md-6">
              <div className="input-group">
                ...
                <input type="text" className="form-control" placeholder="Search by schedule or date..." value={searchText} onChange={handleSearchChange}/>
              </div>
            </div>
      ...
      {Array.isArray(trips) &&
        trips.map((trip) => (
          <div
            ...
            id={`deleteTripModal${trip.id}`}
            tabIndex="-1"
            aria-labelledby={`deleteTripModalLabel${trip.id}`}
            aria-hidden="true"
              ...
              <div className="modal-content">
                <div className="modal-header">
                  <h5
                    ...
                    id={`deleteTripModalLabel${trip.id}`}
                  >
                    Remove Trip
                  </h5>
                  <button
                ...
                <div className="modal-body">
                  Do you want to delete trip scheduled on{" "}
                  <strong>{trip.scheduleNumber}</strong>?
                </div>
